...
<link rel="stylesheet" type="text/css" href="/statics/locacss/main.css">
                    ...
                    <li>
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c">
                                    <h2>零食 / 糖果 / 巧克力</h2>
                                    <a href="#">坚果</a>|<a href="/search/search_product.html?queryString=蜜饯">蜜饯</a>|<a href="#">红枣</a>|<a href="#">牛肉干</a>|<a href="#">巧克力</a>|
...
<div class="lbt">
 <!--Begin Banner Begin-->
        ...
        <%--    <c:choose>
                  ...
                  <c:when test="${CategoryMap.Cate1 }"> --%>
                      <c:forEach items="${CategoryMap.Cate1.advertisingList }" var="adv">
                             <li>           
                               <a href="http://${adv.advertisinToUrl }">                
                             
                               <img  src="http://119.29.195.240${adv.advertisinUrl }" width="${CategoryMap.Cate1.advertisinWidet }" height="${CategoryMap.Cate1.advertisinHight }"/>  
                              </a>  
                             </li>
                      </c:forEach>
              ...
              <%--     </c:when>
                  ...
                  <c:otherwise>
                    <li><img src="https://aecpm.alicdn.com/simba/img/TB1W4nPJFXXXXbSXpXXSutbFXXX.jpg" width="850" height="401"/></li>
                    <li><img src="https://aecpm.alicdn.com/simba/img/TB1_JXrLVXXXXbZXVXXSutbFXXX.jpg" width="850" height="401"/></li> 
                    <li><img src="https://img.alicdn.com/tps/i4/TB1HjvoihnaK1RjSZFBSuwW7VXa.jpg_q60.jpg" width="850" height="401"/></li>      
                  </c:otherwise>
                </c:choose>    --%>
 ...
 <script type="text/javascript" src="/statics/locajs/main.js"></script>
<!--  获取登陆信息  <script type="text/javascript" src="/statics/locajs/jquery-1.6.4.js"></script>
