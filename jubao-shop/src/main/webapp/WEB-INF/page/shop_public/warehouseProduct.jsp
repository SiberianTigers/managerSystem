...
<div class="panel panel-default">
  ...
  <!-- Table -->
  <table class="table">
    <tr><td style="width: 70px">商品名</td><td style="width: 50px">图片</td><td style="width: 50px">价格</td><td style="width: 50px">库存</td><td style="width: 50px"> 状态</td><td style="width: 50px">销量</td><td style="width: 70px">操作</td></tr>
      <c:forEach items="${productList }" var="product">
        <tr>
           <td style="width: 50px">${product.title }</td>
            ...
            <td style="width: 50px"><a href="javaScript:void(0)" class="shangjia" pid="${product.pid }" >上架</a>&nbsp;&nbsp;&nbsp;<a>修改</a>&nbsp;&nbsp;&nbsp;</span><a href="javascript:void(0)" class="deleteProduct" pid=${product.pid } > 删除</a></td>
        </tr>
     </c:forEach>
  </table>
</div>