...
<!-- 		<div class="content mar_20"> -->
			<!-- <div class="two_bg"> -->
				...
				<table border="0" class="car_tab" style="width:1200px;"
					...
					<c:forEach items="${cart.itemList }" var="cart">
						<tr>
							<td>
								<div class="c_s_img">	
								 <img src="http://119.29.195.240${cart.item.image }" width="73" height="73" />
								</div> 
								店铺:${cart.item.storeName }<br/>
								${cart.item.title }
								<br/>
							</td>
				...
				<table border="0" style="width:1200px; margin-top:20px;"
					...
					<tr>
						<td align="right">该订单完成后，您将获得 <font color="#ff4e00">${cart.price }</font>
							...
							color="#ff4e00">￥${cart.price }</font> + 配送费用: <font
							color="#ff4e00">￥15.00</font>
						</td>
					</tr>
					<tr height="70">
						<td align="right"><b style="font-size:14px;">应付款金额：<span
								style="font-size:22px; color:#ff4e00;">￥${cart.price+15 }</span></b>
						</td>
					</tr>
					<tr height="70">
...
${ctx}/pay-page/ddpay.jsp
 --%>
                          <form action="/order/order/create_Order" method="post" id="createOrderForm">
                           <input type="hidden" name="address" id="address"/>
                          </form>
						
						<td align="right"><a href="javascript:void(0)" onclick="createOrder()">
