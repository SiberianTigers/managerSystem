...
<div class="i_bg">  
 ...
 <tr><td colspan="6">店铺：${store.name}</td></tr>
      <c:forEach items="${store.itemList }" var="cart">  
          <tr>
            <td>
            	<div class="c_s_img"><img src="${cart.item.image }" width="73" height="73" /></div>
                ${cart.item.title }
            </td>
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="http://localhost:8086"><img src="${ctx}/statics/images/buy1.gif" /></a>&nbsp; &nbsp; <a  href="http://localhost:8088/order/order/confirm_order.html"><img src="${ctx}/statics/images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
