...
<link rel="stylesheet" type="text/css" href="/statics/m_css/style.css">
<script type="text/javascript" src="/statics/js/common/jquery-1.12.4.min.js"></script>
...
<div class="soubg">
	<div class="sou">
		<span class="fr"> <span class="fl">你好,<a
				href="http://localhost:8086/login/user/userManager">${user.userCode }</a>&nbsp; <a href="Regist.html"
...
<div class="top">
	...
	<div class="logo">
		<a href="http://localhost:8083"><img
			src="/statics/images/jubao.png" /></a>
	</div>
